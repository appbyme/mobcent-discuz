...
$scriptlang[APPBYME_DZ_PLUGIN_ID] = array(
    ...
    'mobcent_portal_module_param_other_filter' => '其他条件选择,好友',
    'mobcent_portal_module_param_topic_picrequired' => '必须含图片附件',
    'mobcent_portal_module_param_topic_orderby' => '主题排序方式,按最后回复时间倒序排序,按发布时间倒序排序,按回复数倒序排序,按浏览次数倒序排序,按热度倒序排序,按主题评价倒序排序,按距离倒序排序(只包括客户端主题)',
