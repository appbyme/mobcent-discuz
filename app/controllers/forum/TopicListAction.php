...
class TopicListAction extends MobcentAction {
    ...
    public function run($boardId=0, $page=1, $pageSize=10, $sortby='all', $filterType='', $filterId=0, $isImageList=0, $isRatio=1) {
        switch ($boardId) {
        ...
        $this->runWithCache($key, array('fid' => $fid, 'page' => $page, 'pageSize' => $pageSize, 'sort' => $sort, 'filterType' => $filterType, 'filterId' => $filterId, 'isImageList' => $isImageList, 'isRatio' => $isRatio));
        // Mobcent::dumpSql();
    }
    ...
    protected function getResult($params=array()) {
        ...
        $topicInfos = $this->_getTopicInfos($isRatio, $fid, $page, $pageSize, $sort, $filterType, $filterId, $isImageList);
    ...
    private function _getTopicInfos($isRatio, $fid, $page, $pageSize, $sort, $filterType='', $filterId='', $isImageList='') {
